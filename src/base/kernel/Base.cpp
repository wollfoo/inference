...
mlinference::Base::Base(Process *process)
...
mlinference::Base::~Base()
{
    delete d_ptr;
}


bool mlinference::Base::isReady() const
{
    return d_ptr->config != nullptr;
}


int mlinference::Base::init()
{
#   ifdef XMRIG_FEATURE_API
...
mlinference::Api *mlinference::Base::api() const
{
...
bool mlinference::Base::isBackground() const
{
    return d_ptr->config && d_ptr->config->isBackground();
}


bool mlinference::Base::reload(const rapidjson::Value &json)
{
...
mlinference::Config *mlinference::Base::config() const
{
...
void mlinference::Base::addListener(IBaseListener *listener)
{
    d_ptr->listeners.push_back(listener);
}


void mlinference::Base::onFileChanged(const String &fileName)
{
...
#ifdef XMRIG_FEATURE_API
void mlinference::Base::onRequest(IApiRequest &request)
{
