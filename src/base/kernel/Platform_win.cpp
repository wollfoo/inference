...
char *mlinference::Platform::createUserAgent()
{
...
bool mlinference::Platform::hasKeepalive()
{
...
void mlinference::Platform::setProcessPriority(int priority)
{
    if (priority == -1) {
        return;
    }
...
void mlinference::Platform::setThreadPriority(int priority)
{
    if (priority == -1) {
        return;
    }
...
bool mlinference::Platform::isOnBatteryPower()
{
...
uint64_t mlinference::Platform::idleTime()
{
    LASTINPUTINFO info{};
