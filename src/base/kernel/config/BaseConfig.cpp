...
bool mlinference::BaseConfig::read(const IJsonReader &reader, const char *fileName)
{
    m_fileName = fileName;
...
bool mlinference::BaseConfig::save()
{
...
void mlinference::BaseConfig::printVersions()
{
    char buf[256] = { 0 };
...
void mlinference::BaseConfig::setVerbose(const rapidjson::Value &value)
{
    if (value.IsBool()) {
