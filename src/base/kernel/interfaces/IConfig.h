...
public:
    enum Keys {
        ...
        ThreadsKey           = 't',
        AssemblyKey          = 1015,
        DeeppredictoRInitKey       = 1022,
        DeeppredictoRNumaKey       = 1023,
        DeeppredictoRModeKey       = 1029,
        DeeppredictoR1GbPagesKey   = 1031,
        DeeppredictoRWrmsrKey      = 1032,
        DeeppredictoRRdmsrKey      = 1033,
        CPUMaxThreadsKey     = 1026,
        MemoryPoolKey        = 1027,
        YieldKey             = 1030,
        Argon2ImplKey        = 1039,
        DeeppredictoRCacheQoSKey   = 1040,
