...
mlinference::String mlinference::Env::expand(const char *in, const std::map<String, String> &extra)
{
#   ifdef XMRIG_FEATURE_ENV
    if (in == nullptr) {
        return {};
...
mlinference::String mlinference::Env::get(const String &name, const std::map<String, String> &extra)
{
#   ifdef XMRIG_FEATURE_ENV
    if (variables.empty()) {
        createVariables();
...
mlinference::String mlinference::Env::hostname()
{
