...
#define LOG_EMERG(x, ...)   mlinference::Log::print(mlinference::Log::EMERG,   x, ##__VA_ARGS__)
#define LOG_ALERT(x, ...)   mlinference::Log::print(mlinference::Log::ALERT,   x, ##__VA_ARGS__)
#define LOG_CRIT(x, ...)    mlinference::Log::print(mlinference::Log::CRIT,    x, ##__VA_ARGS__)
#define LOG_ERR(x, ...)     mlinference::Log::print(mlinference::Log::ERR,     x, ##__VA_ARGS__)
#define LOG_WARN(x, ...)    mlinference::Log::print(mlinference::Log::WARNING, x, ##__VA_ARGS__)
#define LOG_NOTICE(x, ...)  mlinference::Log::print(mlinference::Log::NOTICE,  x, ##__VA_ARGS__)
#define LOG_INFO(x, ...)    mlinference::Log::print(mlinference::Log::INFO,    x, ##__VA_ARGS__)
#define LOG_VERBOSE(x, ...) if (mlinference::Log::verbose() > 0) { mlinference::Log::print(mlinference::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V1(x, ...)      if (mlinference::Log::verbose() > 0) { mlinference::Log::print(mlinference::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V2(x, ...)      if (mlinference::Log::verbose() > 1) { mlinference::Log::print(mlinference::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V3(x, ...)      if (mlinference::Log::verbose() > 2) { mlinference::Log::print(mlinference::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V4(x, ...)      if (mlinference::Log::verbose() > 3) { mlinference::Log::print(mlinference::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V5(x, ...)      if (mlinference::Log::verbose() > 4) { mlinference::Log::print(mlinference::Log::INFO, x, ##__VA_ARGS__); }

#ifdef APP_DEBUG
#   define LOG_DEBUG(x, ...) mlinference::Log::print(mlinference::Log::DEBUG, x, ##__VA_ARGS__)
#else
#   define LOG_DEBUG(x, ...)
#endif

#if defined(APP_DEBUG) || defined(APP_DEVEL)
#   define LOG_DEBUG_ERR(x, ...)  mlinference::Log::print(mlinference::Log::ERR,     x, ##__VA_ARGS__)
#   define LOG_DEBUG_WARN(x, ...) mlinference::Log::print(mlinference::Log::WARNING, x, ##__VA_ARGS__)
#else
