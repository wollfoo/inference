...
#ifdef SIGUSR1
static const int signums[mlinference::Signals::kSignalsCount] = { SIGHUP, SIGINT, SIGTERM, SIGUSR1 };
#else
static const int signums[mlinference::Signals::kSignalsCount] = { SIGHUP, SIGINT, SIGTERM };
#endif


mlinference::Signals::Signals(ISignalListener *listener)
    : m_listener(listener)
{
#   ifndef XMRIG_OS_WIN
...
void mlinference::Signals::onSignal(uv_signal_t *handle, int signum)
{
    switch (signum)
    {
    case SIGHUP:
