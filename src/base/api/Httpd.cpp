...
mlinference::Httpd::Httpd(Base *base) :
    m_base(base)
{
...
mlinference::Httpd::~Httpd() = default;


bool mlinference::Httpd::start()
{
...
void mlinference::Httpd::onConfigChanged(Config *config, Config *previousConfig)
{
...
void mlinference::Httpd::onHttpData(const HttpData &data)
{
...
int mlinference::Httpd::auth(const HttpData &req) const
{
