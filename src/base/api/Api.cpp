...
void mlinference::Api::request(const HttpData &req)
{
...
void mlinference::Api::onConfigChanged(Config *config, Config *previousConfig)
{
...
void mlinference::Api::exec(IApiRequest &request)
{
    using namespace rapidjson;
...
void mlinference::Api::genId(const String &id)
{
...
void mlinference::Api::genWorkerId(const String &id)
{
