...
mlinference::HttpApiRequest::HttpApiRequest(const HttpData &req, bool restricted) :
...
bool mlinference::HttpApiRequest::accept()
{
...
const rapidjson::Value &mlinference::HttpApiRequest::json() const
{
    if (type() == REQ_JSON_RPC) {
...
mlinference::IApiRequest::Method mlinference::HttpApiRequest::method() const
{
    return static_cast<IApiRequest::Method>(m_req.method);
}


void mlinference::HttpApiRequest::done(int status)
{
...
void mlinference::HttpApiRequest::setRpcError(int code, const char *message)
{
    using namespace rapidjson;
    auto &allocator = doc().GetAllocator();
...
void mlinference::HttpApiRequest::setRpcResult(rapidjson::Value &result)
{
    rpcDone(kResult, result);
}


void mlinference::HttpApiRequest::rpcDone(const char *key, rapidjson::Value &value)
{
    ApiRequest::done(0);
