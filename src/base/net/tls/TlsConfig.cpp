 ...
 */
mlinference::TlsConfig::TlsConfig(const rapidjson::Value &value)
{
    if (value.IsObject()) {
...
bool mlinference::TlsConfig::generate(const char *commonName)
{
    TlsGen gen;
...
rapidjson::Value mlinference::TlsConfig::toJSON(rapidjson::Document &doc) const
{
...
void mlinference::TlsConfig::setProtocols(const char *protocols)
{
...
void mlinference::TlsConfig::setProtocols(const rapidjson::Value &protocols)
{
    m_protocols = 0;
