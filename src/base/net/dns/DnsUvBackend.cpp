...
mlinference::DnsUvBackend::DnsUvBackend()
{
...
std::shared_ptr<mlinference::DnsRequest> mlinference::DnsUvBackend::resolve(const String &host, IDnsListener *listener, uint64_t ttl)
{
...
bool mlinference::DnsUvBackend::resolve(const String &host)
{
...
void mlinference::DnsUvBackend::done()
{
...
void mlinference::DnsUvBackend::onResolved(int status, addrinfo *res)
{
...
void mlinference::DnsUvBackend::onResolved(uv_getaddrinfo_t *req, int status, addrinfo *res)
{
