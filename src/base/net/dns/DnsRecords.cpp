...
const mlinference::DnsRecord &mlinference::DnsRecords::get(DnsRecord::Type prefered) const
{
...
size_t mlinference::DnsRecords::count(DnsRecord::Type type) const
{
    if (type == DnsRecord::A) {
        return m_ipv4.size();
    }
...
void mlinference::DnsRecords::clear()
{
    m_ipv4.clear();
    m_ipv6.clear();
}
...
void mlinference::DnsRecords::parse(addrinfo *res)
{
    clear();
