...
mlinference::DnsRecord::DnsRecord(const addrinfo *addr) :
...
const sockaddr *mlinference::DnsRecord::addr(uint16_t port) const
{
...
mlinference::String mlinference::DnsRecord::ip() const
{
    char *buf = nullptr;
