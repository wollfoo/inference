...
mlinference::LineReader::~LineReader()
{
    NetBuffer::release(m_buf);
}


void mlinference::LineReader::parse(char *data, size_t size)
{
...
void mlinference::LineReader::reset()
{
    if (m_buf) {
        NetBuffer::release(m_buf);
        m_buf = nullptr;
...
void mlinference::LineReader::add(const char *data, size_t size)
{
...
void mlinference::LineReader::getline(char *data, size_t size)
{
    char *end        = nullptr;
    char *start      = data;
