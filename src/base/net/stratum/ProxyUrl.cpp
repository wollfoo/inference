...
mlinference::ProxyUrl::ProxyUrl(const rapidjson::Value &value)
{
    m_port = 0;
...
const mlinference::String &mlinference::ProxyUrl::host() const
{
    return m_host.isNull() && isValid() ? kLocalhost : m_host;
}


rapidjson::Value mlinference::ProxyUrl::toJSON(rapidjson::Document &doc) const
{
