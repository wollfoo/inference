...
mlinference::EthStratumClient::EthStratumClient(int id, const char *agent, IClientListener *listener) :
    Client(id, agent, listener)
{
}


int64_t mlinference::EthStratumClient::submit(const JobResult& result)
{
...
void mlinference::EthStratumClient::login()
{
    m_results.clear();
...
void mlinference::EthStratumClient::onClose()
{
    m_authorized = false;
    Client::onClose();
}
...
bool mlinference::EthStratumClient::handleResponse(int64_t id, const rapidjson::Value &result, const rapidjson::Value &error)
{
...
void mlinference::EthStratumClient::parseNotification(const char *method, const rapidjson::Value &params, const rapidjson::Value &)
{
...
void mlinference::EthStratumClient::setExtraNonce(const rapidjson::Value &nonce)
{
    if (!nonce.IsString()) {
...
const char *mlinference::EthStratumClient::errorMessage(const rapidjson::Value &error)
{
...
void mlinference::EthStratumClient::authorize()
{
    using namespace rapidjson;
...
void mlinference::EthStratumClient::onAuthorizeResponse(const rapidjson::Value &result, bool success, uint64_t)
{
    try {
        if (!success) {
...
void mlinference::EthStratumClient::onSubscribeResponse(const rapidjson::Value &result, bool success, uint64_t)
{
    if (!success) {
        return;
    }
...
void mlinference::EthStratumClient::subscribe()
{
    using namespace rapidjson;
