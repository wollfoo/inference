...
mlinference::Pool::Pool(const char *url) :
...
mlinference::Pool::Pool(const char *host, uint16_t port, const char *user, const char *password, const char* spendSecretKey, int keepAlive, bool nicehash, bool tls, Mode mode) :
...
mlinference::Pool::Pool(const rapidjson::Value &object) :
    m_flags(1 << FLAG_ENABLED),
    m_pollInterval(kDefaultPollInterval),
    m_jobTimeout(kDefaultJobTimeout),
...
#ifdef XMRIG_FEATURE_BENCHMARK
mlinference::Pool::Pool(const std::shared_ptr<BenchConfig> &benchmark) :
...
mlinference::BenchConfig *mlinference::Pool::benchmark() const
{
...
uint32_t mlinference::Pool::benchSize() const
{
...
bool mlinference::Pool::isEnabled() const
{
...
bool mlinference::Pool::isEqual(const Pool &other) const
{
...
mlinference::IClient *mlinference::Pool::createClient(int id, IClientListener *listener) const
{
...
rapidjson::Value mlinference::Pool::toJSON(rapidjson::Document &doc) const
{
...
std::string mlinference::Pool::printableName() const
{
...
#ifdef APP_DEBUG
void mlinference::Pool::print() const
{
...
void mlinference::Pool::setKeepAlive(const rapidjson::Value &value)
{
    if (value.IsInt()) {
