...
bool mlinference::WalletAddress::decode(const char *address, size_t size)
{
    uint64_t tf_tag = 0;
...
bool mlinference::WalletAddress::decode(const rapidjson::Value &address)
{
    return address.IsString() && decode(address.GetString(), address.GetStringLength());
}


const char *mlinference::WalletAddress::netName() const
{
...
const char *mlinference::WalletAddress::typeName() const
{
...
rapidjson::Value mlinference::WalletAddress::toJSON(rapidjson::Document &doc) const
{
...
rapidjson::Value mlinference::WalletAddress::toAPI(rapidjson::Document &doc) const
{
    using namespace rapidjson;
...
const mlinference::WalletAddress::TagInfo &mlinference::WalletAddress::tagInfo(uint64_t tag)
{
