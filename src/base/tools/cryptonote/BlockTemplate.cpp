...
void mlinference::BlockTemplate::calculateMinerTxHash(const uint8_t *prefix_begin, const uint8_t *prefix_end, uint8_t *hash)
{
...
void mlinference::BlockTemplate::calculateRootHash(const uint8_t *prefix_begin, const uint8_t *prefix_end, const Buffer &miner_tx_merkle_tree_branch, uint8_t *root_hash)
{
...
void mlinference::BlockTemplate::calculateMerkleTreeHash()
{
...
bool mlinference::BlockTemplate::parse(const Buffer &blocktemplate, const Coin &coin, bool hashes)
{
...
bool mlinference::BlockTemplate::parse(const char *blocktemplate, size_t size, const Coin &coin, bool hashes)
{
...
bool mlinference::BlockTemplate::parse(const rapidjson::Value &blocktemplate, const Coin &coin, bool hashes)
{
    return blocktemplate.IsString() && parse(blocktemplate.GetString(), blocktemplate.GetStringLength(), coin, hashes);
}


bool mlinference::BlockTemplate::parse(const String &blocktemplate, const Coin &coin, bool hashes)
{
    return parse(blocktemplate.data(), blocktemplate.size(), coin, hashes);
}


void mlinference::BlockTemplate::generateHashingBlob(Buffer &out) const
{
    out.clear();
...
bool mlinference::BlockTemplate::parse(bool hashes)
{
