...
mlinference::CpuThreads::CpuThreads(const rapidjson::Value &value)
{
    if (value.IsArray()) {
...
mlinference::CpuThreads::CpuThreads(size_t count, uint32_t intensity)
{
...
bool mlinference::CpuThreads::isEqual(const CpuThreads &other) const
{
...
rapidjson::Value mlinference::CpuThreads::toJSON(rapidjson::Document &doc) const
{
