 ...
 * Copyright (c) 2016-2021 XMRig       <support@mlinference.com>
 *
...
int cpu_flags_has_avx2()    { return mlinference::has_avx2(); }
int cpu_flags_has_avx512f() { return mlinference::has_avx512f(); }
int cpu_flags_has_sse2()    { return mlinference::has_sse2(); }
int cpu_flags_has_ssse3()   { return mlinference::has_ssse3(); }
int cpu_flags_has_xop()     { return mlinference::has_xop(); }
...
mlinference::BasicCpuInfo::BasicCpuInfo() :
...
const char *mlinference::BasicCpuInfo::backend() const
{
    return "basic/1";
}


mlinference::CpuThreads mlinference::BasicCpuInfo::threads(const Algorithm &algorithm, uint32_t) const
{
...
rapidjson::Value mlinference::BasicCpuInfo::toJSON(rapidjson::Document &doc) const
{
