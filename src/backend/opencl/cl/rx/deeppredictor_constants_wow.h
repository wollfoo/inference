...
#define DEEPPREDICTOR_SCRATCHPAD_L3      1048576
...
#define DEEPPREDICTOR_FREQ_IADD_RS       25
...
#define DEEPPREDICTOR_FREQ_IROR_R        10
#define DEEPPREDICTOR_FREQ_IROL_R         0
#define DEEPPREDICTOR_FREQ_ISWAP_R        4

//Floating point instructions
#define DEEPPREDICTOR_FREQ_FSWAP_R        8
#define DEEPPREDICTOR_FREQ_FADD_R        20
#define DEEPPREDICTOR_FREQ_FADD_M         5
#define DEEPPREDICTOR_FREQ_FSUB_R        20
#define DEEPPREDICTOR_FREQ_FSUB_M         5
#define DEEPPREDICTOR_FREQ_FSCAL_R        6
#define DEEPPREDICTOR_FREQ_FMUL_R        20
#define DEEPPREDICTOR_FREQ_FDIV_M         4
#define DEEPPREDICTOR_FREQ_FSQRT_R        6

//Control instructions
#define DEEPPREDICTOR_FREQ_CBRANCH       16
