...
void mlinference::Blake2bInitialHashDoubleKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void mlinference::Blake2bInitialHashDoubleKernel::setArgs(cl_mem out, cl_mem blockTemplate)
{
...
void mlinference::Blake2bInitialHashDoubleKernel::setBlobSize(size_t size)
{
...
void mlinference::Blake2bInitialHashDoubleKernel::setNonce(uint32_t nonce)
{
