...
mlinference::OclContext::OclContext(const OclDevice &device)
{
...
mlinference::OclContext::~OclContext()
{
    if (m_ctx) {
...
bool mlinference::OclContext::init(const std::vector<OclDevice> &devices, std::vector<OclLaunchData> &threads)
{
    if (!m_ctx) {
