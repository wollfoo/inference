...
std::vector<mlinference::OclPlatform> mlinference::OclPlatform::get()
{
...
void mlinference::OclPlatform::print()
{
...
rapidjson::Value mlinference::OclPlatform::toJSON(rapidjson::Document &doc) const
{
...
std::vector<mlinference::OclDevice> mlinference::OclPlatform::devices() const
{
...
mlinference::String mlinference::OclPlatform::extensions() const
{
    return OclLib::getString(id(), CL_PLATFORM_EXTENSIONS);
}


mlinference::String mlinference::OclPlatform::name() const
{
    return OclLib::getString(id(), CL_PLATFORM_NAME);
}


mlinference::String mlinference::OclPlatform::profile() const
{
    return OclLib::getString(id(), CL_PLATFORM_PROFILE);
}


mlinference::String mlinference::OclPlatform::vendor() const
{
    return OclLib::getString(id(), CL_PLATFORM_VENDOR);
}


mlinference::String mlinference::OclPlatform::version() const
{
