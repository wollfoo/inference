...
mlinference::OclRxBaseRunner::OclRxBaseRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
mlinference::OclRxBaseRunner::~OclRxBaseRunner()
{
...
void mlinference::OclRxBaseRunner::run(uint32_t nonce, uint32_t nonce_offset, uint32_t *hashOutput)
{
...
void mlinference::OclRxBaseRunner::set(const Job &job, uint8_t *blob)
{
...
size_t mlinference::OclRxBaseRunner::bufferSize() const
{
...
void mlinference::OclRxBaseRunner::build()
{
    OclBaseRunner::build();
...
void mlinference::OclRxBaseRunner::init()
{
    OclBaseRunner::init();
