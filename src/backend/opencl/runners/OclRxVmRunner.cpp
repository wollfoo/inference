...
mlinference::OclRxVmRunner::OclRxVmRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


mlinference::OclRxVmRunner::~OclRxVmRunner()
{
    delete m_init_vm;
    delete m_execute_vm;
...
size_t mlinference::OclRxVmRunner::bufferSize() const
{
    return OclRxBaseRunner::bufferSize() + (align(2560 * m_intensity));
}


void mlinference::OclRxVmRunner::build()
{
...
void mlinference::OclRxVmRunner::execute(uint32_t iteration)
{
...
void mlinference::OclRxVmRunner::init()
{
