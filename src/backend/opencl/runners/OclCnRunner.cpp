...
mlinference::OclCnRunner::OclCnRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
mlinference::OclCnRunner::~OclCnRunner()
{
    delete m_cn0;
    delete m_cn1;
    delete m_cn2;
...
size_t mlinference::OclCnRunner::bufferSize() const
{
...
void mlinference::OclCnRunner::run(uint32_t nonce, uint32_t /*nonce_offset*/, uint32_t *hashOutput)
{
...
void mlinference::OclCnRunner::set(const Job &job, uint8_t *blob)
{
...
void mlinference::OclCnRunner::build()
{
    OclBaseRunner::build();
...
void mlinference::OclCnRunner::init()
{
    OclBaseRunner::init();
