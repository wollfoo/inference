...
template <class T>
const T &mlinference::Threads<T>::get(const String &profileName) const
{
    static T empty;
...
template <class T>
size_t mlinference::Threads<T>::read(const rapidjson::Value &value)
{
...
template <class T>
mlinference::String mlinference::Threads<T>::profileName(const Algorithm &algorithm, bool strict) const
{
...
template <class T>
void mlinference::Threads<T>::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
    using namespace rapidjson;
