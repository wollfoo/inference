...
mlinference::Hashrate::Hashrate(size_t threads) :
    m_threads(threads + 1)
{
...
double mlinference::Hashrate::average() const
{
...
const char *mlinference::Hashrate::format(double h, char *buf, size_t size)
{
    return ::format(h, buf, size);
}


rapidjson::Value mlinference::Hashrate::normalize(double d)
{
...
rapidjson::Value mlinference::Hashrate::toJSON(rapidjson::Document &doc) const
{
...
rapidjson::Value mlinference::Hashrate::toJSON(size_t threadId, rapidjson::Document &doc) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
...
double mlinference::Hashrate::hashrate(size_t index, size_t ms) const
{
    ...
    const uint64_t timeStampLimit = mlinference::Chrono::steadyMSecs() - ms;
...
void mlinference::Hashrate::addData(size_t index, uint64_t count, uint64_t timestamp)
{
