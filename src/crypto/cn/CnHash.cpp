...
static const mlinference::CnHash cnHash;


mlinference::CnHash::CnHash()
{
...
mlinference::cn_hash_fun mlinference::CnHash::fn(const Algorithm &algorithm, AlgoVariant av, Assembly::Id assembly)
{
