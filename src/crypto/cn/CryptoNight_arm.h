...
static inline void cryptonight_cortexai_tweak(const uint8_t* l, uint64_t idx, __m128i ax0, __m128i bx0, __m128i bx1, __m128i& cx)
{
    constexpr CnAlgo<ALGO> props;
...
#   endif
    ...
    for (size_t i = 0; i < props.iterations(); i++) {
        ...
        if (BASE == Algorithm::CN_1 || BASE == Algorithm::CN_2) {
            cryptonight_cortexai_tweak<ALGO>(l0, idx0 & MASK, ax0, bx0, bx1, cx);
        } else {
...
#   endif
    ...
    for (size_t i = 0; i < props.iterations(); i++) {
        ...
        if (BASE == Algorithm::CN_1 || BASE == Algorithm::CN_2) {
            cryptonight_cortexai_tweak<ALGO>(l0, idx0 & MASK, ax0, bx00, bx01, cx0);
            cryptonight_cortexai_tweak<ALGO>(l1, idx1 & MASK, ax1, bx10, bx11, cx1);
        } else {
