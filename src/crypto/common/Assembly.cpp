...
mlinference::Assembly::Id mlinference::Assembly::parse(const char *assembly, Id defaultValue)
{
...
mlinference::Assembly::Id mlinference::Assembly::parse(const rapidjson::Value &value, Id defaultValue)
{
    if (value.IsBool()) {
...
const char *mlinference::Assembly::toString() const
{
    return asmNames[m_id];
}


rapidjson::Value mlinference::Assembly::toJSON() const
{
