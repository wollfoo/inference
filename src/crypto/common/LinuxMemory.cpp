...
bool mlinference::LinuxMemory::reserve(size_t size, uint32_t node, size_t hugePageSize)
{
...
bool mlinference::LinuxMemory::write(const char *path, uint64_t value)
{
...
int64_t mlinference::LinuxMemory::read(const char *path)
{
