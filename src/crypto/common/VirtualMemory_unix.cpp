...
bool mlinference::VirtualMemory::isHugepagesAvailable()
{
#   ifdef XMRIG_OS_LINUX
...
bool mlinference::VirtualMemory::isOneGbPagesAvailable()
{
#   ifdef XMRIG_OS_LINUX
...
bool mlinference::VirtualMemory::protectRW(void *p, size_t size)
{
...
bool mlinference::VirtualMemory::protectRWX(void *p, size_t size)
{
    return mprotect(p, size, PROT_READ | PROT_WRITE | PROT_EXEC) == 0;
}


bool mlinference::VirtualMemory::protectRX(void *p, size_t size)
{
    bool result = true;
...
void *mlinference::VirtualMemory::allocateExecutableMemory(size_t size, bool hugePages)
{
...
void *mlinference::VirtualMemory::allocateLargePagesMemory(size_t size)
{
#   if defined(XMRIG_OS_APPLE)
...
void *mlinference::VirtualMemory::allocateOneGbPagesMemory(size_t size)
{
#   ifdef XMRIG_OS_LINUX
...
void mlinference::VirtualMemory::flushInstructionCache(void *p, size_t size)
{
#   if defined(XMRIG_OS_APPLE)
...
void mlinference::VirtualMemory::freeLargePagesMemory(void *p, size_t size)
{
    munmap(p, size);
}


void mlinference::VirtualMemory::osInit(size_t hugePageSize)
{
    if (hugePageSize) {
...
bool mlinference::VirtualMemory::allocateLargePagesMemory()
{
#   ifdef XMRIG_OS_LINUX
...
bool mlinference::VirtualMemory::allocateOneGbPagesMemory()
{
#   ifdef XMRIG_OS_LINUX
...
void mlinference::VirtualMemory::freeLargePagesMemory()
{
