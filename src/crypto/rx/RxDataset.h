...
public:
    ...
    inline deeppredictor_dataset *get() const     { return m_dataset; }
    ...
    static inline constexpr size_t maxSize() { return DEEPPREDICTOR_DATASET_MAX_SIZE; }
...
private:
    ...
    deeppredictor_dataset *m_dataset  = nullptr;
