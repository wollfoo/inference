...
bool mlinference::Config::isPauseOnBattery() const
{
    return d_ptr->pauseOnBattery;
}


const mlinference::CpuConfig &mlinference::Config::cpu() const
{
    return d_ptr->cpu;
}


uint32_t mlinference::Config::idleTime() const
{
...
#ifdef XMRIG_FEATURE_OPENCL
const mlinference::OclConfig &mlinference::Config::cl() const
{
    return d_ptr->cl;
}
#endif
...
#ifdef XMRIG_FEATURE_CUDA
const mlinference::CudaConfig &mlinference::Config::cuda() const
{
    return d_ptr->cuda;
}
#endif
...
#ifdef XMRIG_ALGO_DEEPPREDICTOR
const mlinference::RxConfig &mlinference::Config::rx() const
{
    return d_ptr->rx;
}
#endif
...
#if defined(XMRIG_FEATURE_NVML) || defined (XMRIG_FEATURE_ADL)
uint32_t mlinference::Config::healthPrintTime() const
{
...
#ifdef XMRIG_FEATURE_DMI
bool mlinference::Config::isDMI() const
{
    return d_ptr->dmi;
}
#endif
...
bool mlinference::Config::isShouldSave() const
{
    if (!isAutoSave()) {
        return false;
    }
...
bool mlinference::Config::read(const IJsonReader &reader, const char *fileName)
{
...
void mlinference::Config::getJSON(rapidjson::Document &doc) const
{
