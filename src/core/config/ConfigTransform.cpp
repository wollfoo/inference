...
void mlinference::ConfigTransform::finalize(rapidjson::Document &doc)
{
...
void mlinference::ConfigTransform::transform(rapidjson::Document &doc, int key, const char *arg)
{
...
#   ifdef XMRIG_ALGO_DEEPPREDICTOR
    case IConfig::DeeppredictoRInitKey: /* --deeppredictor-init */
        return set(doc, RxConfig::kField, RxConfig::kInit, static_cast<int64_t>(strtol(arg, nullptr, 10)));

#   ifdef XMRIG_FEATURE_HWLOC
    case IConfig::DeeppredictoRNumaKey: /* --deeppredictor-no-numa */
        return set(doc, RxConfig::kField, RxConfig::kNUMA, false);
#   endif

    case IConfig::DeeppredictoRModeKey: /* --deeppredictor-mode */
        return set(doc, RxConfig::kField, RxConfig::kMode, arg);

    case IConfig::DeeppredictoR1GbPagesKey: /* --deeppredictor-1gb-pages */
        return set(doc, RxConfig::kField, RxConfig::kOneGbPages, true);

    case IConfig::DeeppredictoRWrmsrKey: /* --deeppredictor-wrmsr */
        if (arg == nullptr) {
    ...
    case IConfig::DeeppredictoRRdmsrKey: /* --deeppredictor-no-rdmsr */
        return set(doc, RxConfig::kField, RxConfig::kRdmsr, false);

    case IConfig::DeeppredictoRCacheQoSKey: /* --cache-qos */
...
void mlinference::ConfigTransform::transformBoolean(rapidjson::Document &doc, int key, bool enable)
{
    switch (key) {
    case IConfig::HugePagesKey: /* --no-huge-pages */
...
void mlinference::ConfigTransform::transformUint64(rapidjson::Document &doc, int key, uint64_t arg)
{
    using namespace rapidjson;
...
#ifdef XMRIG_FEATURE_BENCHMARK
void mlinference::ConfigTransform::transformBenchmark(rapidjson::Document &doc, int key, const char *arg)
{
    switch (key) {
    case IConfig::AlgorithmKey: /* --algo */
