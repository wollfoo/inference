...
mlinference::Controller::Controller(Process *process) :
    Base(process)
{
}


mlinference::Controller::~Controller()
{
    VirtualMemory::destroy();
}


int mlinference::Controller::init()
{
    Base::init();
...
void mlinference::Controller::start()
{
    Base::start();
...
void mlinference::Controller::stop()
{
    Base::stop();
...
mlinference::Miner *mlinference::Controller::miner() const
{
    assert(m_miner);
...
mlinference::Network *mlinference::Controller::network() const
{
    assert(m_network);
...
void mlinference::Controller::execCommand(char command) const
{
