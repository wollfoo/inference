...
const char *mlinference::Msr::tag()
{
    return kTag;
}
...
std::shared_ptr<mlinference::Msr> mlinference::Msr::get()
{
...
bool mlinference::Msr::write(uint32_t reg, uint64_t value, int32_t cpu, uint64_t mask, bool verbose)
{
...
mlinference::MsrItem mlinference::Msr::read(uint32_t reg, int32_t cpu, bool verbose) const
{
    uint64_t value = 0;
