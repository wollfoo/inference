...
mlinference::MsrItem::MsrItem(const rapidjson::Value &value)
{
    if (!value.IsString()) {
        return;
    }
...
rapidjson::Value mlinference::MsrItem::toJSON(rapidjson::Document &doc) const
{
    return toString().toJSON(doc);
}


mlinference::String mlinference::MsrItem::toString() const
{
