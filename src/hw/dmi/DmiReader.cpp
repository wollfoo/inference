...
rapidjson::Value mlinference::DmiReader::toJSON(rapidjson::Document &doc) const
{
    rapidjson::Value obj;
    toJSON(obj, doc);
...
void mlinference::DmiReader::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
...
bool mlinference::DmiReader::decode(uint8_t *buf, const Cleanup &cleanup)
{
...
bool mlinference::DmiReader::decode(uint8_t *buf)
{
    if (!buf) {
        return false;
    }
