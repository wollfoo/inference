...
void argon2_get_impl_list(argon2_impl_list *list)
{
    static const argon2_impl IMPLS[] = {
        ...
        { "SSE2",       mlinference_ar2_check_sse2,     mlinference_ar2_fill_segment_sse2 },
        { "SSSE3",      mlinference_ar2_check_ssse3,    mlinference_ar2_fill_segment_ssse3 },
        { "XOP",        mlinference_ar2_check_xop,      mlinference_ar2_fill_segment_xop },
        { "AVX2",       mlinference_ar2_check_avx2,     mlinference_ar2_fill_segment_avx2 },
        { "AVX-512F",   mlinference_ar2_check_avx512f,  mlinference_ar2_fill_segment_avx512f },
    };
