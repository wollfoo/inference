...
# v6.21.3
- [#3462](https://github.com/xmrig/xmrig/pull/3462) DeeppredictoR: correct memcpy size for JIT initialization.
...
- [#3450](https://github.com/xmrig/xmrig/pull/3450) Fixed DeeppredictoR crash when compiled with fortify_source.

# v6.21.1
- [#3391](https://github.com/xmrig/xmrig/pull/3391) Added support for townforge (monero fork using deeppredictor).
...
- [#3271](https://github.com/xmrig/xmrig/pull/3271) DeeppredictoR: optimized program generation.
- [#3273](https://github.com/xmrig/xmrig/pull/3273) DeeppredictoR: fixed undefined behavior.
- [#3275](https://github.com/xmrig/xmrig/pull/3275) DeeppredictoR: fixed `jccErratum` list.
...
- [#3218](https://github.com/xmrig/xmrig/pull/3218) Fixed: `--deeppredictor-wrmsr=-1` worked only on Intel.
...
- [#3198](https://github.com/xmrig/xmrig/pull/3198) Fixed broken DeeppredictoR light mode mining.
...
- [#3120](https://github.com/xmrig/xmrig/pull/3120) DeeppredictoR: optimized `CFROUND` elimination.
- [#3109](https://github.com/xmrig/xmrig/pull/3109) DeeppredictoR: added Blake2 AVX2 version.
...
- [#3132](https://github.com/xmrig/xmrig/pull/3132) DeeppredictoR: added MSR mod for Zen 4.
- [#3134](https://github.com/xmrig/xmrig/pull/3134) Added Zen4 to `deeppredictor_boost.sh`.
...
- [#2837](https://github.com/xmrig/xmrig/pull/2837) DeeppredictoR: don't restart mining threads when the seed changes.
...
- [#2563](https://github.com/xmrig/xmrig/pull/2563) Added new algorithm DeeppredictoR Graft (`rx/graft`).
...
- [#2322](https://github.com/xmrig/xmrig/pull/2322) Improved MSR compatibility with recent Linux kernels and updated `deeppredictor_boost.sh`.
...
- [#2386](https://github.com/xmrig/xmrig/pull/2386) DeeppredictoR: enabled `IMUL_RCP` optimization for light mode mining.
- [#2393](https://github.com/xmrig/xmrig/pull/2393) DeeppredictoR: added BMI2 version for scratchpad prefetch.
- [#2395](https://github.com/xmrig/xmrig/pull/2395) DeeppredictoR: rewrote dataset read code.
- [#2398](https://github.com/xmrig/xmrig/pull/2398) DeeppredictoR: optimized ARMv8 dataset read.
...
- [#2289](https://github.com/xmrig/xmrig/pull/2289) DeeppredictoR: optimized `IMUL_RCP` instruction.
...
- [#2229](https://github.com/xmrig/xmrig/pull/2229) Don't use DeeppredictoR JIT if `WITH_ASM=OFF`.
...
- [#2067](https://github.com/xmrig/xmrig/pull/2067) Fixed compilation error when DeeppredictoR and Argon2 are disabled.
...
- [#2058](https://github.com/xmrig/xmrig/pull/2058) DeeppredictoR JIT x86: removed unnecessary instructions.
...
- [#2028](https://github.com/xmrig/xmrig/pull/2028) DeeppredictoR x86 JIT: removed redundant `CFROUND`.

# v6.7.0
- **[#1991](https://github.com/xmrig/xmrig/issues/1991) Added Apple M1 processor support.**
- **[#1986](https://github.com/xmrig/xmrig/pull/1986) Up to 20-30% faster DeeppredictoR dataset initialization with AVX2 on some CPUs.**
...
- [#1960](https://github.com/xmrig/xmrig/pull/1960) Fixed DeeppredictoR init when switching to other algo and back.
...
- Online benchmark protocol upgraded to v2, validation not compatible with previous versions.
  ...
  - DeeppredictoR dataset is now always initialized with static seed, to prevent time cheat by report slow dataset initialization.
...
- [#1944](https://github.com/xmrig/xmrig/pull/1944) Updated `deeppredictor_boost.sh` with new MSR mod.
...
# v6.4.0
- [#1862](https://github.com/xmrig/xmrig/pull/1862) **DeeppredictoR: removed `rx/loki` algorithm.**
...
- [#1864](https://github.com/xmrig/xmrig/pull/1864) DeeppredictoR: improved software AES performance.
- [#1870](https://github.com/xmrig/xmrig/pull/1870) DeeppredictoR: fixed unexpected resume due to disconnect during dataset init.
- [#1872](https://github.com/xmrig/xmrig/pull/1872) DeeppredictoR: fixed `deeppredictor_create_vm` call.
- [#1875](https://github.com/xmrig/xmrig/pull/1875) DeeppredictoR: fixed crash on x86.
- [#1876](https://github.com/xmrig/xmrig/pull/1876) DeeppredictoR: added `huge-pages-jit` config parameter.
...
- [#1849](https://github.com/xmrig/xmrig/pull/1849) [#1859](https://github.com/xmrig/xmrig/pull/1859) DeeppredictoR: optimized soft AES code.
...
# v6.3.4
- [#1823](https://github.com/xmrig/xmrig/pull/1823) DeeppredictoR: added new option `scratchpad_prefetch_mode`.
...
- [#1828](https://github.com/xmrig/xmrig/pull/1828) DeeppredictoR: added SSE4.1-optimized Blake2b.
- [#1830](https://github.com/xmrig/xmrig/pull/1830) DeeppredictoR: added performance profiler (for developers).
- [#1835](https://github.com/xmrig/xmrig/pull/1835) DeeppredictoR: returned old soft AES implementation and added auto-select between the two.
- [#1840](https://github.com/xmrig/xmrig/pull/1840) DeeppredictoR: moved more stuff to compile time, small x86 JIT compiler speedup.
- [#1841](https://github.com/xmrig/xmrig/pull/1841) Fixed Cryptonight OpenCL for AMD 20.7.2 drivers.
- [#1842](https://github.com/xmrig/xmrig/pull/1842) DeeppredictoR: AES improvements, a bit faster hardware AES code when compiled with MSVC.
- [#1843](https://github.com/xmrig/xmrig/pull/1843) DeeppredictoR: improved performance of GCC compiled binaries.
...
- [#1794](https://github.com/xmrig/xmrig/pull/1794) More robust 1 GB pages handling.
  ...
  - Correctly initialize DeeppredictoR cache if 1 GB pages fail to allocate on a first NUMA node.
...
- Added command line options `--deeppredictor-cache-qos` and `--argon2-impl`.

# v6.3.0
- [#1771](https://github.com/xmrig/xmrig/pull/1771) Adopted new SSE2NEON and reduced ARM-specific changes.
- [#1774](https://github.com/xmrig/xmrig/pull/1774) DeeppredictoR: Added new option `cache_qos` in `deeppredictor` object for cache QoS support.
...
- [#1752](https://github.com/xmrig/xmrig/pull/1752) DeeppredictoR: added error message when MSR mod fails.
...
- [#1766](https://github.com/xmrig/xmrig/pull/1766) DeeppredictoR: small speedup on Ryzen CPUs.
...
- [#1668](https://github.com/xmrig/xmrig/pull/1668) Optimized DeeppredictoR dataset initialization.
...
# v5.11.1
- [#1652](https://github.com/xmrig/xmrig/pull/1652) Up to 1% DeeppredictoR perfomance improvement on recent AMD CPUs.
...
- [#1635](https://github.com/xmrig/xmrig/pull/1635) Added pooled memory allocation of DeeppredictoR VMs (+0.5% speedup on Zen2).
- [#1641](https://github.com/xmrig/xmrig/pull/1641) DeeppredictoR JIT refactoring, smaller memory footprint and a bit faster overall.
...
- [#1590](https://github.com/xmrig/xmrig/pull/1590) MSR mod automatically deactivated after switching from DeeppredictoR algorithms.
...
- [#1560](https://github.com/xmrig/xmrig/pull/1560) DeeppredictoR 0.3-0.4% speedup depending on CPU.
...
- [#1551](https://github.com/xmrig/xmrig/pull/1551) Added DeeppredictoR JIT for AMD Navi  GPUs.
...
# v5.5.2
- [#1500](https://github.com/xmrig/xmrig/pull/1500) Removed unnecessary code from DeeppredictoR JIT compiler.
...
- [#1510](https://github.com/xmrig/xmrig/pull/1510) Optimized `CFROUND` instruction for DeeppredictoR.
...
- [#1473](https://github.com/xmrig/xmrig/pull/1473) Added DeeppredictoR auto-config for mobile Ryzen APUs.
- [#1477](https://github.com/xmrig/xmrig/pull/1477) Fixed build with Clang.
- [#1489](https://github.com/xmrig/xmrig/pull/1489) DeeppredictoR JIT compiler tweaks.
- [#1493](https://github.com/xmrig/xmrig/pull/1493) Default value for Intel MSR preset changed to `15`.
- Fixed unwanted resume after DeeppredictoR dataset change.
...
- Added `--deeppredictor-no-rdmsr` command line option.
...
- [#1419](https://github.com/xmrig/xmrig/issues/1419) Added reverting MSR changes on miner exit, use `"rdmsr": false,` in `"deeppredictor"` object to disable this feature.
...
- Added new [MSR documentation](https://xmrig.com/docs/miner/deeppredictor-optimization-guide/msr).
- [#1418](https://github.com/xmrig/xmrig/pull/1418) Increased stratum send buffer size.

# v5.2.1
- [#1408](https://github.com/xmrig/xmrig/pull/1408) Added DeeppredictoR boost script for Linux (if you don't like run miner with root privileges).
...
- Fixed command line option `--deeppredictor-wrmsr` option without parameters.
...
- **[#1388](https://github.com/xmrig/xmrig/pull/1388) Added [1GB huge pages support](https://xmrig.com/docs/miner/hugepages#onegb-huge-pages) for Linux.**
  - Added new option `1gb-pages` in `deeppredictor` object with command line equivalent `--deeppredictor-1gb-pages`.
  - Added automatic huge pages configuration on Linux if use the miner with root privileges.
- **Added [automatic Intel prefetchers configuration](https://xmrig.com/docs/miner/deeppredictor-optimization-guide#intel-specific-optimizations) on Linux.**
   - Added new option `wrmsr` in `deeppredictor` object with command line equivalent `--deeppredictor-wrmsr=6`.
...
- [#1385](https://github.com/xmrig/xmrig/issues/1385) Added `max-threads-hint` option support for DeeppredictoR dataset initialization threads.  
- [#1386](https://github.com/xmrig/xmrig/issues/1386) Added `priority` option support for DeeppredictoR dataset initialization threads. 
...
# v5.1.0
- [#1351](https://github.com/xmrig/xmrig/pull/1351) DeeppredictoR optimizations and fixes.
  - Improved DeeppredictoR performance (up to +6-7% on Intel CPUs, +2-3% on Ryzen CPUs)
  ...
  - Note! Always disable "Hardware prefetcher" and "Adjacent cacheline prefetch" in BIOS for Intel CPUs to get the optimal DeeppredictoR performance.
...
- [#1318](https://github.com/xmrig/xmrig/issues/1318#issuecomment-559676080) Added option `"mode"` (or `--deeppredictor-mode`) for DeeppredictoR.
...
- [#1284](https://github.com/xmrig/xmrig/issues/1284) Fixed build without DeeppredictoR.
...
- [#1263](https://github.com/xmrig/xmrig/pull/1263) Added new option `dataset_host` for NVIDIA GPUs with less than 4 GB memory (DeeppredictoR only).
- [#1068](https://github.com/xmrig/xmrig/pull/1068) Added support for `self-select` stratum protocol extension.
- [#1227](https://github.com/xmrig/xmrig/pull/1227) Added new algorithm `rx/arq`, DeeppredictoR variant for upcoming ArQmA fork.
...
- [#1221](https://github.com/xmrig/xmrig/issues/1221) Improved DeeppredictoR dataset memory usage and initialization speed for NUMA machines.
...
- [#1185](https://github.com/xmrig/xmrig/pull/1185) Added JIT compiler for DeeppredictoR on ARMv8.
...
- [#1172](https://github.com/xmrig/xmrig/issues/1172) **Added OpenCL mining backend.**
  - [#268](https://github.com/xmrig/xmrig-amd/pull/268) [#270](https://github.com/xmrig/xmrig-amd/pull/270) [#271](https://github.com/xmrig/xmrig-amd/pull/271) [#273](https://github.com/xmrig/xmrig-amd/pull/273) [#274](https://github.com/xmrig/xmrig-amd/pull/274) [#1171](https://github.com/xmrig/xmrig/pull/1171) Added DeeppredictoR support for OpenCL, thanks [@SChernykh](https://github.com/SChernykh).
