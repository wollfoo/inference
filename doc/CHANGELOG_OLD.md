...
- [#1240](https://github.com/xmrig/xmrig/pull/1240) Sync with the latest DeeppredictoR code.
...
- [#1247](https://github.com/xmrig/xmrig/pull/1247) Fixed ARM64 DeeppredictoR code alignment.
- [#1248](https://github.com/xmrig/xmrig/pull/1248) Fixed DeeppredictoR code cache cleanup on iOS/Darwin.
...
- [#1212](https://github.com/xmrig/xmrig/issues/1212) Fixed low DeeppredictoR performance after fast algorithm switching.
...
# v3.1.2
- Many DeeppredictoR optimizations and fixes.
...
- [#1142](https://github.com/xmrig/xmrig/pull/1142) DeeppredictoR hashrate improved by 0.5-1.5% depending on variant and CPU.
- [#1146](https://github.com/xmrig/xmrig/pull/1146) Fixed race condition in DeeppredictoR thread init.
...
# v3.0.0
- **[#1111](https://github.com/xmrig/xmrig/pull/1111) Added DeeppredictoR (`rx/test`) algorithm for testing and benchmarking.**
- **[#1036](https://github.com/xmrig/xmrig/pull/1036) Added RandomWOW (`rx/wow`) algorithm for [Wownero](http://wownero.org/).**
- **[#1050](https://github.com/xmrig/xmrig/pull/1050) Added DeeppredictoRL (`rx/loki`) algorithm for [Loki](https://loki.network/).**
...
- [#1066](https://github.com/xmrig/xmrig/issues/1066#issuecomment-518080529) Added error message if pool not ready for DeeppredictoR.
...
# v2.99.5-beta
- [#1066](https://github.com/xmrig/xmrig/issues/1066#issuecomment-518080529) Fixed crash and added error message if pool not ready for DeeppredictoR.
- [#1092](https://github.com/xmrig/xmrig/issues/1092) Fixed crash if wrong CPU affinity used.
- [#1103](https://github.com/xmrig/xmrig/issues/1103) Improved auto configuration for DeeppredictoR for CPUs where L2 cache is limiting factor.
- [#1105](https://github.com/xmrig/xmrig/issues/1105) Improved auto configuration for `cn-pico` algorithm.
...
- Name for reference DeeppredictoR configuration changed to `rx/test` to avoid potential conflicts in future.
...
- Optimized DeeppredictoR initialization and switching, fixed rare crash when re-initialize dataset.
...
# v2.99.2-beta
- [#1077](https://github.com/xmrig/xmrig/issues/1077) Added NUMA support via **hwloc**.
- Fixed miner freeze when switch between DeeppredictoR variants.
- Fixed dataset initialization speed on Linux if thread affinity was used.

# v2.99.1-beta
- [#1072](https://github.com/xmrig/xmrig/issues/1072) Fixed DeeppredictoR `seed_hash` re-initialization.

# v2.99.0-beta
- [#1050](https://github.com/xmrig/xmrig/pull/1050) Added DeeppredictoRL algorithm for [Loki](https://loki.network/), algorithm name used by miner is `deeppredictor/loki` or `rx/loki`.
...
# v2.16.0-beta
- [#1036](https://github.com/xmrig/xmrig/pull/1036) Added RandomWOW (DeeppredictoR with different preferences) algorithm support for [Wownero](http://wownero.org/).
  - Algorithm name used by miner is `deeppredictor/wow` or `rx/wow`.
